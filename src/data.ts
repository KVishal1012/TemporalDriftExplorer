...
export const cityProfiles: Record<CityKey, CityProfile> = {
  toronto: {
    ...
    geometry: {
      center: ll(43.646, -79.3974),
      zoom: 15,
      tilt: 45,
      heading: 82,
      bounds: [ll(43.6481, -79.4092), ll(43.6488, -79.3866), ll(43.6439, -79.3858), ll(43.6432, -79.4086)],
      businessDensityPath: [ll(43.6452, -79.4084), ll(43.6458, -79.4025), ll(43.6463, -79.3966), ll(43.6469, -79.3891)],
      demographicAreas: [
        [ll(43.6502, -79.409), ll(43.649, -79.401), ll(43.646, -79.402), ll(43.647, -79.410)],
        [ll(43.6468, -79.394), ll(43.6476, -79.386), ll(43.6427, -79.386), ll(43.6421, -79.395)],
      ],
      zoningParcels: [
        { id: "tor-mixed-1", use: "Mixed Use", color: "#df923e", geometry: [ll(43.6483, -79.409), ll(43.6486, -79.401), ll(43.6454, -79.400), ll(43.645, -79.408)] },
        { id: "tor-commercial-1", use: "Commercial", color: "#e8614e", geometry: [ll(43.6485, -79.401), ll(43.6487, -79.394), ll(43.6455, -79.393), ll(43.6453, -79.400)] },
        { id: "tor-residential-1", use: "Residential", color: "#d4b637", geometry: [ll(43.6487, -79.394), ll(43.6488, -79.386), ll(43.6456, -79.386), ll(43.6455, -79.393)] },
      ],
    },
    ...
    findings: [
      { id: 1, title: "Mixed-use infill strengthened daytime demand", body: "Seeded fallback finding aligned to Toronto Open Data source slots until live ingestion is configured.", position: { x: 28, y: 45 }, anchor: ll(43.646, -79.4055), sourceIds: ["toronto-open-data", "alphaearth-foundations"], provenance: "seeded-fallback" },
      { id: 2, title: "Transit priority improved corridor access", body: "Streetcar and walkability evidence will be joined with corridor observations once live feeds are connected.", position: { x: 52, y: 50 }, anchor: ll(43.6463, -79.3972), sourceIds: ["ttc-open-data", "alphaearth-foundations"], provenance: "seeded-fallback" },
      { id: 3, title: "Residential growth supported evening activity", body: "Statistics Canada source metadata is ready; current values remain fallback demo observations.", position: { x: 76, y: 44 }, anchor: ll(43.6468, -79.3895), sourceIds: ["statistics-canada", "alphaearth-foundations"], provenance: "seeded-fallback" },
    ],
    evidence: [
