...
export const civicDatasetContracts: CivicDatasetContract[] = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        format: "geojson",
        url: "https://ckan0.cf.opendata.inter.prod-toronto.ca/datastore/dump/d75fa1ed-cd04-4a0b-bb6d-2b928ffffa6e?format=geojson",
        status: "pending-live-ingestion",
      },
    ],
    nextAction: "POST /api/ingest/toronto/zoning with INGEST_API_TOKEN after TIMESCALE_DATABASE_URL is configured.",
    notes: "The ingestion endpoint discovers the current CKAN GeoJSON cache, filters features intersecting the King Street West corridor, and writes matching rows to TimescaleDB.",
  },
  {
